...
var DataTableFn = function(){
  ...
  configDT.aoColumns = [
    ...
    { "sTitle": "<?= $this->lang->line("País") ?>", "mData": "country", "sType": "string"},
    { "sClass": "text-align-center", "sWidth": "70px", "sTitle": "<?= $this->lang->line("Dominio") ?>", "mData": "domain", "sType": "string"},
    { "sClass": "text-align-center", "sWidth": "70px", "sTitle": "<?= $this->lang->line("Extensión") ?>", "mData": "ext", "sType": "string"},
