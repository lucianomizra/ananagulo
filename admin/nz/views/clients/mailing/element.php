...
<? $field = 'mailing'; $this->load->view('app/form', array('item' => array(
    'columns' => 10,
    'form' => $wgetId,
    'name' => $field,
...
<? $field = 'count'; $this->load->view('app/form', array('item' => array(
    'type' => 'number',
    'columns' => 2,
    'form' => $wgetId,
    'name' => $field,
...
<? $field = 'result'; $this->load->view('app/form', array('item' => array(
    'columns' => 12,
    'form' => $wgetId,
    'name' => $field,
...
<? $field = 'data'; $this->load->view('app/form', array('item' => array(
    'type' => 'textarea',
    'height' => 400,
    'columns' => 12,
    'form' => $wgetId,
