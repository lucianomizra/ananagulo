...
var DataTableFn = function(){
  ...
  configDT.aoColumns = [
    ...
    { "sTitle": "<?= $this->lang->line("Mailing") ?>", "mData": "mailing", "sType": "string"},
    { "sTitle": "<?= $this->lang->line("Resultado") ?>", "mData": "result", "sType": "string"},
    { "sWidth": "120px", "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("Fecha") ?>", "mData": "time", "sType": "html", "mRender" : function( data, type, full ){ 
      if(!data || data == '0000-00-00 00:00') return '-';
      return Date.fromMysql(data).format("dd/MM/yyyy hh:mm:ss");
    }},
    { "sWidth": "30px", "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("Envíos") ?>", "mData": "count", "sType": "string"},
