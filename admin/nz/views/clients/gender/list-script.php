...
var DataTableFn = function(){
  ...
  configDT.aoColumns = [
    ...
    { "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("Género") ?>", "mData": "gender", "sType": "string"},
    { "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("Sigla") ?>", "mData": "code", "sType": "string"},
