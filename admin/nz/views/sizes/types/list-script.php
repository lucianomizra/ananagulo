...
var DataTableFn = function(){
  ...
  configDT.fnServerParams = function ( aoData ) {
    if($('#show_nameFormChk<?= $wgetId ?>').prop('checked'))
      aoData.push( { "name": "filter-show_name", "value": 1 } );
  ...
  configDT.aoColumns = [
    ...
    { "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("Tallas") ?>", "mData": "sizes", "sType": "string"},
    { "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("Orden") ?>", "mData": "num", "sType": "string"},
    { "sClass": "text-align-center", "sWidth": "40px", "sTitle": "<?= $this->lang->line("Mostrar Nombre") ?>", "mData": "show_name", "sType": "html", "mRender" : function( data, type, full ){ 
