...
var DataTableFn = function(){
  ...
  configDT.aoColumns = [
    ...
    { "sTitle": "<?= $this->lang->line("Nombre") ?>", "mData": "color", "sType": "string"},
    { "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("HEX") ?>", "mData": "value" },
    { "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("Color") ?>", "mData": "value", "sType": "html", "mRender" : function( data, type, full ){ 
      return '<span style="width:22px;height:22px;display:inline-block;position:relative;top:3px;background:'+data+'"></span>';
    }},
