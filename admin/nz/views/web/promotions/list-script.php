...
var DataTableFn = function(){
  ...
  configDT.fnServerParams = function ( aoData ) {
    ...
    if($('#homeFormChk<?= $wgetId ?>').prop('checked'))
      aoData.push( { "name": "filter-home", "value": 1 } );
  ...
  configDT.aoColumns = [
    ...
    */?>
    ...
    { "sClass": "text-align-center", "sWidth": "40px", "sTitle": "<?= $this->lang->line("Mostrar en Home") ?>", "mData": "home", "sType": "html", "mRender" : function( data, type, full ){ 
      if(!data || !parseInt(data)) return '<?= $this->lang->line("No") ?>';
      return '<?= $this->lang->line("Si") ?>';
    }},
    { "sClass": "text-align-center", "sWidth": "40px", "sTitle": "<?= $this->lang->line("Mostrar en Looks") ?>", "mData": "looks", "sType": "html", "mRender" : function( data, type, full ){ 
      if(!data || !parseInt(data)) return '<?= $this->lang->line("No") ?>';
      return '<?= $this->lang->line("Si") ?>';
    }},
    { "sClass": "text-align-center", "sWidth": "40px", "sTitle": "<?= $this->lang->line("Mostrar en Colecciones") ?>", "mData": "collections", "sType": "html", "mRender" : function( data, type, full ){ 
      if(!data || !parseInt(data)) return '<?= $this->lang->line("No") ?>';
      return '<?= $this->lang->line("Si") ?>';
    }},
    { "sClass": "text-align-center", "sWidth": "40px", "sTitle": "<?= $this->lang->line("Mostrar en Rebajas") ?>", "mData": "reductions", "sType": "html", "mRender" : function( data, type, full ){ 
      if(!data || !parseInt(data)) return '<?= $this->lang->line("No") ?>';
      return '<?= $this->lang->line("Si") ?>';
    }},
