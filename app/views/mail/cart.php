...
Gracias por comprar en nuestra tienda el día <span style="font-weight:bold"><?= date('d/m/Y') ?></span> a las <span style="font-weight:bold"><?= date('H:i:s') ?></span>.
</div>
<div style="margin-bottom:20px;margin-top:5px;font-size:11px;">
<div style="margin-bottom:3px;font-size:11px;font-weight:bold;font-size:12px">AVISO IMPORTANTE:</div>
Recibirás otro e-mail cuando tu pedido esté listo para su recogida en tienda.<br/>
Contactaremos contigo si la disponibilidad del producto que has comprado se retrasa más de lo previsto.
</div>
<div style="margin-bottom:30px;margin-top:5px;font-size:11px;overflow:hidden">
<div style="width:50%;float:left">
<span style="font-weight:bold">DIRECCIÓN DE ENVIO</span><br/>
